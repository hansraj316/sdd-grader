...
- [~] spec-maqa-missing-priority — SPEC-MAQA-MISSING-PRIORITY: spec with 3+ FR reqs but no priority annotation (MoSCoW/P1-P3/High-Low) → issue #137 → PR #142
...
- #137 → PR #142 spec-maqa-missing-priority — awaiting CI
