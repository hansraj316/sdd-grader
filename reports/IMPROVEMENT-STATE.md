...
- #116 (issue #113) plan-third-party-no-fallback — PLAN-THIRD-PARTY-NO-FALLBACK: integration plan names external API/service with no resilience vocabulary (retry, timeout, fallback, circuit breaker); awaiting CI.
