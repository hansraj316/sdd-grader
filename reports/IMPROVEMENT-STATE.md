...
- [~] spec-qvscribe-shall-be-able-to — promoted to issue #148 (research: QVscribe capability optionality defect) → PR #152
...
- [~] #148 → PR #152 spec-qvscribe-shall-be-able-to — SPEC-QVSCRIBE-SHALL-BE-ABLE-TO: 'shall be able to' capability phrasing dilutes mandatory obligation; _SHALL_BE_ABLE_TO_RE + _requirement_mask() scoping; 16 unit tests (7 fire, 9 silent); pytest 798 green; benchmark good=100 bad=55.0 precision=0.972 PASS; awaiting CI
